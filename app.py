...
def main():
    ...
    if choice == "Home":
        ...
        if analyze_4:
            ...
            raw_text = get_clean(raw_text)
            speech_emotion = model_hateSpeech.predict(tfidf_hateSpeech.transform([raw_text]))
            
            if speech_emotion[0] == 0:
                st.write("**HATE SPEECH**")
            elif speech_emotion[0] == 1:
                st.write("**OFFENSIVE LANGUAGE**")
            elif speech_emotion[0] == 2:
                st.write("**NEITHER**")  
...
if __name__ == "__main__":
    ...
    model_hateSpeech = pickle.load(open('model_hateSpeech.pkl', 'rb'))
    tfidf_hateSpeech = pickle.load(open('tfidf_hateSpeech.pkl', 'rb'))
